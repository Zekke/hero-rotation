...
local function EvaluateCycleRake(TargetUnit)
  ...
  return (Player:BuffUp(S.SuddenAmbushBuff) and Player:PMultiplier(S.Rake) > TargetUnit:PMultiplier(S.Rake) and BTBuffDown(S.Rake))
end
...
local function AoeBuilder()
  ...
  if S.BrutalSlash:IsReady() then
    ...
    -- TEST : check pourquoi �a �value tous les ennemis
  end
