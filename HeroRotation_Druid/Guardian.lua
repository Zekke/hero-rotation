...
local function APL()
  ...
  if Everyone.TargetIsValid() then
    ...
    if CDsON() and Settings.Commons.Enabled.Items and I.BestinSlotsMelee:IsReady() and (Player:BuffUp(S.Incarnation) or Player:BuffUp(S.Berserk)) then
    ...
    if CDsON() and Settings.Commons.Enabled.Trinkets and I.TomeofLightsDevotion:IsReady() and (Player:BuffUp(S.InnerResilienceBuff)) then
