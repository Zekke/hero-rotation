...
local function Finishers()
  ...
  if S.HammerofLight:IsReady() and (Player:BuffUp(S.HammerofLightBuff) or not S.DivineHammer:IsAvailable() or Paladin.DivineHammerActive or S.DivineHammer:CooldownRemains() > 10 or not CDsON()) then
