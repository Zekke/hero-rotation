...
local function Cleave()
  ...
  if AnyDnD:IsReady() and Target:IsInMeleeRange(5) and (not Player:DnDTicking() and VarAddsRemain and (S.Apocalypse:CooldownDown() or not S.Apocalypse:IsAvailable())) then
