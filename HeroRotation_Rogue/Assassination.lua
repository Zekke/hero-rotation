...
local function ShivUsage ()
  ...
  if CDsON() and S.LightweightShiv:IsAvailable() and ShivKingsbaneCondition and S.Deathmark:IsReady() and S.Kingsbane:IsReady()
...
local function CDs ()
  ...
  if CDsON() and not Player:StealthUp(true, true) and MasterAssassinRemains() <= 0 or S.IndiscriminateCarnage:IsAvailable()
