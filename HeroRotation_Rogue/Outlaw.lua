...
local function APL ()
  ...
  if not Player:AffectingCombat() and S.Vanish:TimeSinceLastCast() > 1 then
    ...
    if Everyone.TargetIsValid() then
      ...
      if CDsON() and S.AdrenalineRush:IsCastable() --[[and not S.EdgeCase:IsAvailable()]] and S.KeepItRolling:IsAvailable()
      ...
      if Player:StealthUp(true, false) then
        ...
        if CDsON() and S.KeepItRolling:IsAvailable() and S.GhostlyStrike:IsReady() then
