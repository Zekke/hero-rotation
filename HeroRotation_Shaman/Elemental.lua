...
local function Aoe()
  ...
  if CDsON() and S.Stormkeeper:IsViable() and (S.HeraldoftheStorms:IsAvailable() or S.PrimordialWave:CooldownRemains() < Player:GCD() or not S.PrimordialWave:IsAvailable()) then
